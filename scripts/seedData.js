...
const kanji = [
  ...
  // N4
  {
    ...
    strokeCount: 13,
    jlptLevel: "N4",
    examples: [{ word: "働く", reading: "はたらく", meaning: "Làm việc" }],
  },
  {
    id: "k7",
    char: "旅",
    ...
    strokeCount: 10,
    jlptLevel: "N4",
    examples: [{ word: "旅行", reading: "りょこう", meaning: "Du lịch" }],
  },
  {
    id: "k8",
    char: "始",
    ...
    jlptLevel: "N4",
    examples: [
      { word: "開始", reading: "かいし", meaning: "Bắt đầu, khai mạc" },
    ],
  },
  {
    id: "k9",
    ...
    jlptLevel: "N4",
    examples: [
      { word: "終電", reading: "しゅうでん", meaning: "Chuyến tàu cuối" },
    ],
  },
  ...
  // N3
  {
    id: "k10",
    char: "経",
    meaning: "Trải qua, kinh doanh",
    onyomi: ["ケイ"],
    kunyomi: ["へ.る"],
    strokeCount: 11,
    jlptLevel: "N3",
    examples: [{ word: "経験", reading: "けいけん", meaning: "Kinh nghiệm" }],
  },
  {
    id: "k11",
    char: "済",
    meaning: "Hoàn tất, kinh tế",
    onyomi: ["サイ"],
    kunyomi: ["す.む"],
    strokeCount: 11,
    jlptLevel: "N3",
    examples: [{ word: "経済", reading: "けいざい", meaning: "Kinh tế" }],
  },
  {
    id: "k12",
    char: "境",
    meaning: "Biên giới, hoàn cảnh",
    onyomi: ["キョウ"],
    kunyomi: ["さかい"],
    strokeCount: 14,
    jlptLevel: "N3",
    examples: [{ word: "環境", reading: "かんきょう", meaning: "Môi trường" }],
  },
  ...
  // N2
  {
    ...
    strokeCount: 4,
    jlptLevel: "N2",
    examples: [{ word: "予算", reading: "よさん", meaning: "Ngân sách" }],
  },
  {
    id: "k14",
    char: "budget2",
    ...
    strokeCount: 14,
    jlptLevel: "N2",
    examples: [{ word: "計算", reading: "けいさん", meaning: "Tính toán" }],
  },
  ...
  // N1
  {
    ...
    char: "premise2",
    char: "概",
    meaning: "Khái quát, đại khái",
    onyomi: ["ガイ"],
    kunyomi: [],
    strokeCount: 13,
    jlptLevel: "N1",
    examples: [{ word: "概念", reading: "がいねん", meaning: "Khái niệm" }],
  },
  // N4
  {
    id: "k6",
  ...
  },
  {
    id: "k16",
    char: "緊",
    meaning: "Khẩn cấp, căng thẳng",
    onyomi: ["キン"],
    kunyomi: [],
    strokeCount: 15,
    jlptLevel: "N1",
    examples: [{ word: "緊張", reading: "きんちょう", meaning: "Căng thẳng" }],
  },
];
...
async function seed() {
  ...
  console.log("Đang seed grammar...");
  for (const item of grammar) {
    const { id, ...data } = item;
    await db.collection("grammar").doc(id).set(data);
  }
  console.log(`✓ Đã thêm ${grammar.length} mẫu ngữ pháp`);
